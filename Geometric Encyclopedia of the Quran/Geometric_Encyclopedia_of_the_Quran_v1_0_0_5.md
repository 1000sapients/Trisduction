...
Census: 5 entries, 3 major, 2 standard, 0 redirect stubs. This edition admits ʿArsh ʿAẓīm of Sabaʾ at standard tier,
the first entry whose spine cycle and whose own cycle both closed sealed, and the odometer moves from four to five.
...
Commissioned heads, twenty-five, are listed in COMMISSIONED.md and are not entries. A
