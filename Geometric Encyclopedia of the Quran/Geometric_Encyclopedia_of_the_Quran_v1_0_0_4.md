...
Census: 4 entries, 3 major, 1 standard, 0 redirect stubs. This edition admits ʿArsh at standard tier,
the first entry to land inside its declared band, and the odometer moves from three to four.
...
Commissioned heads, twenty-one, are listed in COMMISSIONED.md and are not entries. A
