...
<!--
GEOMETRIC ENCYCLOPAEDIA OF THE QURʾĀN · Seed corpus · Version 1.2.0.2

Version scheme: major.minor.patch.census. The final component is the entry count
and moves only when an entry is added; a correction that adds no entry moves the
patch component and leaves the census standing.
