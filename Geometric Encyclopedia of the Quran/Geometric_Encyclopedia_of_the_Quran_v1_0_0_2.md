...
Seed corpus. Version 1.0.0.2

Version scheme: the final component is the entry census. v1.0.0.2 carries two
...
Spines: Abrogation reads from MD-PSP-ABROGATION-RELOCK-01 in the mathematical
register; Taḥrīf reads from CN-PSP-TAHRIF-GRANT-01 at SC-088 in the theological
register.
