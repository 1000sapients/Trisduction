...
The open question is the one bit, and it is now a single question rather than a sequence of them: is the time evolution of $\zeta$'s modes unitary, equivalently, does Postulate M hold for $\zeta$.
