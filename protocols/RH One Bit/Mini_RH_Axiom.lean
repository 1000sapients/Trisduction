...
/-- The one remaining input, written as an axiom instead of supplied. -/
axiom the_term : ∀ X : Frame, LineProperty X
theorem RH_by_axiom : LineProperty twoPoint := the_term twoPoint
theorem the_axiom_proves_false : False := two_point_fails RH_by_axiom
end Mini
#print axioms Mini.the_axiom_proves_false
