...
|---|---|---|---|
| `TRISDUCTION_Master_Codex_v1_1_2_full.lean` | 1.1.2 | 9ec161b016197ed7 | **Current, full.** Third-round pass: every instance named and guarded, the generator reads instance and axiom commands (M9b, a proof-erased axiom inside `ToString Rat`, now exits 1), the Locus reading carries one slot per orbit and the halt token the bits still owed, the router fidelity universal, `routed` a field of the halt record, D5 closed. 465 guards, exit 0 |
| `TRISDUCTION_Master_Codex_v1_1_2.lean` | 1.1.2 | 2c61d8c342941527 | **Current, barebone.** Program only; same declarations, same 465 guards, byte-identical output |
