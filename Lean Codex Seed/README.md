...
|---|---|---|---|
| `TRISDUCTION_Master_Codex_v1_1_1_full.lean` | 1.1.1 | 04496bb530bf3880 | **Current, full.** The program with every docstring, the version record, the debt ledger, the contract and receipts, the witness map, and all five FORGE records. 12,260 lines, exit 0, 443 guards |
| `TRISDUCTION_Master_Codex_v1_1_1.lean` | 1.1.1 | 91beaa08bb5b3ceb | **Current, barebone.** The same program with zero commentary: no docstrings, no version history, no ledgers, no records. Only declarations, the guard roster (whose docstrings are syntax), and the four Fortran witnesses inside their fences. 9,166 lines, exit 0, the same 443 guards, byte-identical `#eval` output |
