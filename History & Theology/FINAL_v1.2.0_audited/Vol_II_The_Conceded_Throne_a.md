...
**Names, and the honorific convention suspended.** This volume reads one corpus in that corpus's own names. Moses, David, Solomon, Joshua, and the prophets appear in the forms the Hebrew text and its standard English apparatus use, and the author's honorific convention, which marks prophetic names elsewhere in his work, is deliberately not applied here. The suspension is a consequence of the single-corpus constraint of Chapter 1 rather than an exception to it: a study that admits the Hebrew Bible alone as evidence should not carry, in its running text, a naming convention drawn from a corpus it has excluded. Nothing interpretive follows from the choice in either direction. The companion volumes named at the front of this book, which read three corpora, carry the honorific convention in full.
...
**Fenced.** Nothing in this section is load-bearing for any claim in this book. It names the companion volumes and no argument here cites one. The single-corpus constraint of Chapter 1 is unaffected, and Appendix J states where the boundary falls.
...
**The speaker is Balaam**, a foreign diviner hired to curse Israel, whose donkey has spoken to him two chapters earlier. That is the corpus's setting for its clearest Torah statement of a coming ruler and it is worth registering.
...
**Names, and the honorific convention suspended.** Prophetic and royal names appear in the forms the Hebrew text and its standard English apparatus use. The author's honorific convention is not applied in this volume, for the reason stated in the Reading Conventions at the front: a study admitting the Hebrew Bible alone as evidence does not carry, in its running text, a naming convention drawn from an excluded corpus. Nothing interpretive follows from the choice.
